...
- [x] [动态规划（dynamic）](./src/core/algorithms/dynamic/README.md)
- [x] [贪心算法（greedy）](./src/core/algorithms/greedy/README.md)
- [x] [回溯（backtracking）](./src/core/algorithms/backtracking/README.md)
